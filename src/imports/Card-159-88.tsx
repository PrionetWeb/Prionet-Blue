import svgPaths from "./svg-eybufnb637";
...
function HomePage1() {
  return (
    <div className="content-stretch flex h-[41.594px] items-start relative shrink-0 w-full" data-name="HomePage2">
      <p className="font-['Outfit:Bold',sans-serif] font-bold leading-[41.6px] relative shrink-0 text-[#3f3f3f] text-[32px] text-center text-nowrap whitespace-pre">You Stay in Control</p>
    </div>
  );
}
...
function HomePage2() {
  return (
    <div className="h-[96px] relative shrink-0 w-full" data-name="HomePage2">
      <p className="absolute font-['Outfit:Regular',sans-serif] font-normal leading-[24px] left-[143.2px] text-[#3f3f3f] text-[16px] text-center top-0 translate-x-[-50%] w-[283px]">Your privacy comes first. Only you get the private code to allow you secure access to your information.</p>
    </div>
  );
}
