import svgPaths from "./svg-4434tnqtiw";
...
function Heading() {
  return (
    <div className="content-stretch flex h-[31.188px] items-start relative shrink-0 w-full" data-name="Heading 4">
      <p className="basis-0 font-['Outfit:Bold',sans-serif] font-bold grow leading-[31.2px] min-h-px min-w-px relative shrink-0 text-[#3f3f3f] text-[24px]">Privacy Compliant</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Outfit:Regular',sans-serif] font-normal leading-[24px] left-[0.5px] text-[#3f3f3f] text-[16px] top-[0.36px] w-[468px]">Strengthen Relationship / Make payment arrangements; keep your patient</p>
    </div>
  );
}
